...
mask_Br = (Ef_Br == 0.319601) & (T_Br_s > 250)
mask_Cl = (Ef_Cl == 0.391838) & (T_Cl_s > 250)
mask_I = (Ef_I == 0.409473) & (T_I_s > 250)
...
ax8.plot(T_Cl_s[mask_Cl],  T_Cl_s[mask_Cl]*ZT_Cl_s[mask_Cl], label="Cl", color='dodgerblue', linewidth=2.5,marker="^")
ax8.plot(T_Br_s[mask_Br],  T_Br_s[mask_Br]*ZT_Br_s[mask_Br], label="Br", color='olivedrab', linewidth=2.5,marker="^")
ax8.plot(T_I_s[mask_I],  T_I_s[mask_I]*ZT_I_s[mask_I], label="I", color='darkslategrey', linewidth=2.5,marker="^")
