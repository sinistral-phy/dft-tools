...
condtens_Br_s = np.genfromtxt('interpolation.trace', skip_header=1)
...
condtens_I = np.genfromtxt('result_trace_file.trace', skip_header=1)
...
mask_Br = (Ef_Br == 0.157613) & (T_Br_s > 250)
mask_Cl = (Ef_Cl == 0.157628) & (T_Cl_s > 250)
mask_I = (Ef_I == 0.157628) & (T_I_s > 250)
mask_Br_Z = (Ef_Br == 0.157613) & (T_Br_s > 450)
mask_Cl_Z = (Ef_Cl == 0.157628) & (T_Cl_s > 450)	
mask_I_Z = (Ef_I == 0.157628) & (T_I_s > 450)
ax4.plot(T_Cl_s[mask_Cl],  k_Cl_s[mask_Cl], label="Total", color='dodgerblue', linewidth=2.5,marker="o")
ax4.plot(T_Br_s[mask_Br],  k_Br_s[mask_Br], label="spin_dw", color='olivedrab', linewidth=2.5,marker="^")
ax4.plot(T_I_s[mask_I],  k_I_s[mask_I], label="spin_up", color='darkslategrey', linewidth=2.5,marker="^")
ax6.plot(T_Cl_s[mask_Cl],  PF_Cl_s[mask_Cl], label="Total", color='dodgerblue', linewidth=2.5,marker="o")
ax6.plot(T_Br_s[mask_Br],  PF_Br_s[mask_Br], label="spin_dw", color='olivedrab', linewidth=2.5,marker="^")
ax6.plot(T_I_s[mask_I],  PF_I_s[mask_I], label="spin_up", color='darkslategrey', linewidth=2.5,marker="^")
ax8.plot(T_Cl_s[mask_Cl_Z],  T_Cl_s[mask_Cl_Z]*ZT_Cl_s[mask_Cl_Z], label="Total", color='dodgerblue', linewidth=2.5,marker="^")
ax8.plot(T_Br_s[mask_Br_Z],  T_Br_s[mask_Br_Z]*ZT_Br_s[mask_Br_Z], label="spin_dw", color='olivedrab', linewidth=2.5,marker="^")
ax8.plot(T_I_s[mask_I_Z],  T_I_s[mask_I_Z]*ZT_I_s[mask_I_Z], label="spin_up", color='darkslategrey', linewidth=2.5,marker="^")
ax2.plot(T_Cl_s[mask_Cl],  s_Cl_s[mask_Cl], label="Total", color='dodgerblue', linewidth=2.5,marker="o")
ax2.plot(T_Br_s[mask_Br],  s_Br_s[mask_Br], label="spin_dw", color='olivedrab', linewidth=2.5,marker="^")
ax2.plot(T_I_s[mask_I],  s_I_s[mask_I], label="spin_up", color='darkslategrey', linewidth=2.5,marker="^")
ax7.plot(T_Cl_s[mask_Cl],  1000000*S_Cl_s[mask_Cl], label="Total", color='palevioletred', linewidth=2.5,marker="o")
ax7.plot(T_Br_s[mask_Br],  1000000*S_Br_s[mask_Br], label="spin_dw", color='teal', linewidth=2.5,marker="^")
ax7.plot(T_I_s[mask_I],  1000000*S_I_s[mask_I], label="spin_up", color='firebrick', linewidth=2.5,marker="^")
...
ax8.set_xlabel("Temperature (K)")
ax1.text(0.45, 0.9, "Total", transform=ax1.transAxes, fontsize=18, verticalalignment='top', horizontalalignment='center')
ax3.text(0.45, 0.9, "spin_dw", transform=ax3.transAxes, fontsize=18, verticalalignment='top', horizontalalignment='center')
ax5.text(0.45, 0.9, "spin_up", transform=ax5.transAxes, fontsize=18, verticalalignment='top', horizontalalignment='center')
# Apply formatting
...
plt.savefig("transport_componentwise.png", dpi=200, bbox_inches='tight')
